...
function insertTagBlogMapping(tagId, blogId, ctime, wtime, success) {
    var insertSql = "insert into tag_blog_mapping (`tag_id`, `blog_id`, `ctime`, `wtime`) values (?, ?, ?, ?)";
    var params = [tagId, blogId, ctime, wtime];
